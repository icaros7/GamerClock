...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox2.Text = "powershell ""(new-object Net.WebClient).DownloadFile('""https://raw.githubuserconte" &
    "nt.com/icaros7/GamerClock/master/Gamer%20Clock/Gamer_Clock.exe', 'RTSS_Gamer_Clo" &
    "ck.exe')"""
        '
        'Button4
        '
